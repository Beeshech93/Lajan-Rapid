...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "RemesaHaití — Envía dinero a Haití y República Dominicana" },
      { property: "og:description", content: "Envía dinero desde América y Europa a Haití y República Dominicana en minutos. Tipo de cambio transparente y seguimiento en tiempo real." },
      { name: "twitter:description", content: "Envía dinero desde América y Europa a Haití y República Dominicana en minutos. Tipo de cambio transparente y seguimiento en tiempo real." },
