...
// Registro heterogéneo: cada plantilla tiene props propias e incompatibles entre sí;
// `any` es intencional aquí, ya que se instancia dinámicamente vía React.createElement.
...
const SAMPLE_PROJECT_URL = "https://lajanrapid.app";
