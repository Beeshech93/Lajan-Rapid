...
export const Route = createFileRoute("/privacidad")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: "https://lajanrapid.app/privacidad" }],
  }),
        ...
        <article className="prose prose-invert max-w-none space-y-8 text-sm leading-relaxed text-text-secondary">
          <Section title="1. Introducción">
            ...
            <p>
              ...
              protegemos y, cuando corresponda, compartimos información personal cuando una persona
              utiliza:
            </p>
            <List
              items={[
            ...
            />
            <p>
              Esta Política está diseñada para operar en México, Haití y República Dominicana, sin
              perjuicio de otras obligaciones legales que puedan resultar aplicables según el país,
              producto o servicio.
            </p>
          </Section>
          ...
          <Section title="2. Responsable del tratamiento">
            ...
            />
            <p>
              Antes de publicar esta Política, Lajan Rapid deberá completar los datos legales de la
              sociedad responsable, domicilio, correo oficial y, cuando corresponda, representante o
          ...
          <Section title="3. Marco legal">
            ...
            <p>
              Cuando resulte aplicable, el tratamiento de datos personales de usuarios en México se
              realizará conforme a la Ley Federal de Protección de Datos Personales en Posesión de
              los Particulares, cuya versión vigente contempla obligaciones para responsables
              particulares y derechos ARCO.
            </p>
            <h3 className="font-display text-base font-semibold text-foreground">
              República Dominicana
            </h3>
            <p>
              Cuando resulte aplicable, el tratamiento se realizará conforme a la Ley No. 172-13
              sobre Protección de Datos Personales y demás normativa aplicable.
            </p>
            ...
            <p>
              Cuando una legislación local establezca requisitos adicionales, prevalecerán las
              obligaciones legales aplicables a la operación correspondiente.
            </p>
          </Section>

          <Section title="4. Información que recopilamos">
            <p>
              Dependiendo de los servicios utilizados, podemos recopilar las siguientes categorías
              de información.
            </p>
            <h3 className="font-display text-base font-semibold text-foreground">
            ...
            />
            <p>
              Estos datos pueden ser procesados por proveedores especializados de KYC y
              cumplimiento.
            </p>
          </Section>
          ...
          <Section title="5. Información financiera">
            <p>
              Cuando el usuario utiliza servicios financieros podemos recopilar información
              relacionada con:
            </p>
            <List
              items={[
                ...
                "Información relacionada con tarjetas",
              ]}
            />
            <p className="rounded-xl border border-border bg-secondary p-4 text-foreground">
              Importante: Lajan Rapid no almacena el PAN completo ni el CVV de las tarjetas. Los
              datos sensibles son gestionados por proveedores certificados conforme a PCI DSS.
            </p>
          </Section>

          <Section title="6. Información de MonCash y NatCash">
            <p>
              Cuando el usuario utilice servicios relacionados con MonCash, NatCash u otros
              proveedores de dinero móvil, podremos procesar información necesaria para ejecutar y
            ...
            <List
              items={[
                ...
                "Identificador proporcionado por el proveedor",
              ]}
            />
            <p>
              El tratamiento también podrá estar sujeto a las políticas y condiciones del proveedor
              correspondiente.
            </p>
          </Section>
          ...
          <Section title="7. Información del dispositivo">
            ...
            />
            <p>
              Esta información se utiliza principalmente para seguridad, prevención de fraude,
              funcionamiento y diagnóstico técnico.
            </p>
          </Section>
          ...
          <Section title="8. Información de localización">
            ...
            <p>
              Cuando la ubicación precisa no sea necesaria, procuraremos utilizar información menos
              precisa. El usuario podrá controlar los permisos de ubicación desde su dispositivo,
              salvo cuando exista una obligación legal o una necesidad legítima de seguridad que
              permita otro tratamiento.
            </p>
          </Section>
          ...
          <Section title="9. Información de uso">
            ...
            />
            <p>
              Esta información ayuda a mejorar la seguridad, estabilidad y experiencia del usuario.
            </p>
          </Section>
          ...
          <Section title="10. Finalidades del tratamiento">
            ...
            <List
              items={[
                ...
                "Verificar identidad",
                "Realizar procesos KYC",
                "Procesar transferencias",
                "Procesar pagos",
                "Gestionar wallets",
                "Gestionar tarjetas",
                "Procesar recargas",
                "Gestionar operaciones relacionadas con MonCash y NatCash",
                "Gestionar compras online",
                "Gestionar logística",
                "Enviar notificaciones de operaciones",
            ...
            />
            <p>
              El usuario podrá ejercer los mecanismos disponibles para limitar determinadas
          ...
          <Section title="11. Bases para el tratamiento">
            <p>
              Dependiendo de la jurisdicción y del tratamiento concreto, podremos tratar datos con
              base en:
            </p>
            <List
              items={[
                ...
                "Seguridad",
                "Interés legítimo cuando sea legalmente aplicable",
          ...
          <Section title="12. KYC, prevención de fraude y cumplimiento">
            <p>
              Los servicios financieros pueden requerir procedimientos de identificación y
              monitoreo.
            </p>
            ...
            <List
              items={[
                ...
                "Evaluar riesgo",
                "Prevenir uso ilícito de la Plataforma",
                "Cumplir obligaciones regulatorias",
              ]}
            />
            <p>
          ...
          <Section title="13. Compartición de información">
            ...
            />
            <p>
              Los proveedores únicamente deberán recibir la información necesaria para realizar la
          ...
          <Section title="15. Conservación de datos">
            ...
            />
            <p>
              Los plazos pueden variar según el tipo de información y el país. Cuando los datos ya
              no sean necesarios, serán eliminados, anonimizados o bloqueados cuando corresponda.
            </p>
          </Section>
          ...
          <Section title="16. Seguridad">
            ...
            />
            <p>
              El acceso interno a datos personales estará limitado según las funciones y
              responsabilidades.
            </p>
          </Section>
          ...
          <Section title="18. Cookies y tecnologías similares">
            ...
            />
            <p>
              Cuando la legislación aplicable lo requiera, se solicitará el consentimiento
              correspondiente. El usuario podrá controlar determinadas cookies mediante la
              configuración del navegador o mediante el mecanismo de preferencias disponible en el
              sitio.
            </p>
          </Section>
          ...
          <Section title="19. Marketing">
            <p>
              Podremos enviar comunicaciones promocionales cuando exista una base legal válida y,
              cuando sea necesario, consentimiento.
            </p>
            ...
            />
            <p>
              Las comunicaciones esenciales relacionadas con seguridad, operaciones y transacciones
              pueden continuar siendo enviadas aunque el usuario haya rechazado comunicaciones
              comerciales.
            </p>
          </Section>
          ...
          <Section title="20. Derechos del usuario en México">
            <p>
              Cuando resulte aplicable la legislación mexicana, el usuario podrá ejercer los
              derechos:
            </p>
            <List
              items={[
          ...
          <Section title="21. Derechos en República Dominicana">
            <p>
              Los usuarios de República Dominicana podrán ejercer los derechos reconocidos por la
              legislación aplicable, incluyendo los mecanismos establecidos por la Ley No. 172-13.
            </p>
            <p>
          ...
          <Section title="22. Derechos en Haití">
            ...
            <List
              items={[
                ...
                "Información sobre determinados tratamientos",
          ...
          <Section title="23. Solicitudes de privacidad">
            <p>
              Para realizar una solicitud relacionada con privacidad, el usuario deberá contactar:
            </p>
            <List
              items={[
            ...
            <List
              items={[
                "Nombre",
                "Información suficiente para identificar la cuenta",
                "Tipo de solicitud",
            ...
            />
            <p>
              Podremos solicitar información adicional para evitar que una persona no autorizada
          ...
          <Section title="26. Proveedores financieros">
            <p>
              Los servicios financieros pueden depender de instituciones, procesadores, emisores,
              proveedores de tarjetas, redes de pago y otras entidades. El tratamiento realizado
              directamente por esos proveedores puede estar sujeto a sus propias políticas de
              privacidad.
            </p>
          </Section>
          ...
          <Section title="27. Incidentes de seguridad">
            <p>
              En caso de detectar un incidente de seguridad que afecte datos personales, Lajan
              Rapide implementará procedimientos internos para:
            </p>
            <List
              items={[
                ...
                "Notificar a usuarios o autoridades cuando legalmente corresponda",
              ]}
            />
          </Section>
          ...
          <Section title="28. Cambios a esta política">
            <p>
              Podemos modificar esta Política de Privacidad cuando sea necesario. La versión actual
              estará disponible dentro de la aplicación y/o sitio web.
            </p>
            <p>
              Cuando un cambio sea material y la legislación lo requiera, podremos comunicarlo
              mediante:
            </p>
            <List
              items={[
                ...
                "Otros mecanismos legalmente válidos",
              ]}
            />
          ...
          <Section title="30. Aceptación y constancia">
            ...
            />
            <p>
              La aceptación de esta Política no sustituye los consentimientos específicos que puedan
              ser necesarios para determinados tratamientos.
            </p>
          </Section>
